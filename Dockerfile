...
CMD ["sh", "-c", "echo '=== PRISMA DB PUSH START ===' && ./node_modules/.bin/prisma db push --skip-generate --accept-data-loss; echo \"=== PRISMA DB PUSH EXIT CODE: $? ===\" && echo '=== STARTING BOT ===' && node dist/index.js"]
